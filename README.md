...
sweeps and manual checks. Inotify watches have directory/kernel caps; safety sweeps
cover unwatched paths. Existing native watcher tools may have their own limits.
